...
testlib = ctypes.CDLL('/home/fei/Documents/Isaac_DRL/goalkeeperDRL/goalkeeperDRL/examples/blackboard/blackboard.so') #chama a lybrary que contem as funções em c++
